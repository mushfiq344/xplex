            ...
            <div style="position: absolute; top: 10%;left: 10%; color:white; z-index: 3;">
              <div class="row">
                <div class="col-md-3 col-sm-3">
                  <img
                       style="float: right; height: 400px; width: 500px" src="<?php echo e(asset($value->poster_url_value)); ?>" >
                </div>
  ...
  <h2 class="container h1 sub">Movies</h2>
    ...
    <!-- Single Product Block -->
      <div class="item col-lg-2 col-md-3 col-sm-4 col-xs-6">
        <a id="id" href="<?php echo e(url('/pc_games',[$value->id])); ?>" class="angled-img">
          <div class="img img-offset">
            <div class="box" style="height: 336px;">
              <img id="poster_image"  src="<?php echo e(asset($value->poster_url_value)); ?>" alt="" height="336px" style="overflow-y:hidden; ">
              <div class="box-content" style="margin-top:5%">
                <h3 class="title"><?php echo e($value->title); ?></h3>
                <span class="post"><?php echo e(substr($value->plot,0,300)); ?>...</span>
                <br>
                <br>
                <ul class="icon">
                  <li><a class="video-popup" href="<?php echo e($value->trailer_value); ?>"><i class="fa fa-play">
                        Trailer</i></a></li>
                </ul>
              </div>
            </div>
    ...
    <a href="<?php echo e(url('/galleryForPcGame',['all'])); ?>" class="btn pull-right">See More</a>
    <h2 class="container h1 sub">TV Series </h2>
    <div class=" row vertical-gutter">
    <?php foreach ($tv as $value){ ?>
    <!-- Single Product Block -->
      <div class="item col-lg-2 col-md-3 col-sm-4 col-xs-6 active" data-filters="sob">
        <a id="id" href="<?php echo e(url('/tv_series',[$value->id])); ?>" >
          <div class="img img-offset">
            <div class="box">
              ...
              <div class="box-content" style="margin-top:5%">
                <h3 class="title"><?php echo e($value->title); ?></h3>
                <span class="post">IMDB: <?php echo e($value->imdbrating); ?></span>
                <span class="post"><?php echo e($value->plot); ?></span>
                <br>
                <br>
                <ul class="icon">
                  <li><a class="video-popup" href="<?php echo e($value->trailer_value); ?>"><i class="fa fa-play">
    ...
    <br>
    <a href="<?php echo e(url('/galleryForTv',['tv_series','english','all'])); ?>" class="btn pull-right">See More</a>
    <br><br><br>
    <!-- Footer -->
    <br><br>
