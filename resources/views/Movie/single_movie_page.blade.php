...
<head>
    ...
    <!-- Social Likes -->
    <link rel="stylesheet" type="text/css" href="{{asset('../assets/bower_components/social-likes/dist/social-likes_flat.css')}}" />
    <!-- Youplay -->
...
<body>
    ...
    <section class="content-wrap">
        ...
        <div class="youplay-banner banner-top youplay-banner-parallax">
            <div class="image" id="main_image">
                ...
                <div class="videoWrapper">
                    <iframe id="iframe" width="560" height="349" src={!! $url_value !!}></iframe>
                    ...
                    <div class="container" style="margin-left: 10%">
                        <div class="row">
                            <div class="img col-md-4">
                                <img class="sround" id="poster_img" src="{{asset($result->poster_url_value)}}" alt="">
                            </div>
                            <div class="col-md-7">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="col-lg-4" style="padding-top: 10%;">
                                                <img class="rating_img img-responsive" src="{{asset('assets/images/IMDb.ico')}}">
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="youplay-hexagon-rating" data-max="10" data-size="80">
                                                    <span>{{substr($result->imdbrating,0,3)}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="col-lg-4" style="padding-top: 10%;">
                                                <img class="rating_img img-responsive" src="{{asset('assets/images/rottenTomatoes.png')}}">
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="youplay-hexagon-rating" data-max="100" data-size="80">
                                                    <span>{{$result->rottentomatoesrating}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="col-lg-4" style="padding-top: 10%;">
                                                <img class="rating_img img-responsive" src="{{asset('assets/images/metacritic.png')}}">
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="youplay-hexagon-rating" data-max="100" data-size="80">
                                                    <span>{{$result->metacriticrating}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <p><a href="{{url('/movie/director',[$result->director])}}"> {{$result->director}}</a></p>
                            ...
                            <div class="col-md-1" style="padding-top: 38%">
                                <a href="{{$result->trailer_value}}" class="btn btn-primary video-popup">Show Trailer</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- /Banner -->
        <div class="container-fluid" id="container" elemType="movie" elemId="{{$result->id}}" style="margin: 20px">
            <div class="row">
                <div class="col-lg-9">
                    <?php
                    if ($first_copy != "N/A") {
                    ?>
                        <video poster="{{$result->cover_url_value}}" class="centered-and-cropped" style="border-radius: 10px;margin-top: 3px" type='video/x-matroska; codecs="theora, vorbis"' autoplay controls id="video_player" controls controlsList="nodownload" link="{{$first_copy}}">
                            <source id="player_source" src="{{$first_copy}}">
                            ...
                            ?>
                                <div class="row youplay-side-news">
                                    <div class="col-xs-3 col-md-4">
                                        <a href="{{ url('/movie',[$popular->id]) }}">
                                            <div class="img">
                                                <img style="border-radius: 10px" class="rating_img img-responsive" width="100%" src="{{asset($popular->poster_url_value)}}" alt="">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xs-9 col-md-8">
                                        <h4 class="ellipsis"><a href="{{ url('/movie',[$popular->id]) }}" title="Popular Title">{{$popular->title}}</a></h4>
                                        <h6><i class="fa fa fa-bullhorn"></i> {{$popular->released}}</h6>
                                        <h6 style="color: #15FF58"><i class="fa fa-star"></i> {{$popular->imdbrating}}</h6>
                                        <h6><i class="fa fa fa-folder-open"></i> {{$popular->genre}}</h6>
                                        <h6><i class="fa fa fa-eye"></i> {{$popular->total_view}}</h6>
                                    </div>
                                </div>
    ...
    <!-- Social Likes -->
    <script type="text/javascript" src="{{asset('../assets/bower_components/social-likes/dist/social-likes.min.js')}}"></script>
    <!-- Youplay -->
    <script type="text/javascript" src="{{asset('../assets/youplay/js/youplay.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('../assets/youplay/js/comment.js')}}"></script>
