    ...
    <div id="TV Shows" class="tabcontent" style="display:block;">
        ...
        <form action="{{ url('insert_tv_show') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="date" id="released_tv_show"
                           class="form-control"
                           name="released_tv_show" value="{{date('Y-m-d')}}" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4>Country:</h4>
                    <input type="text" id="country_tv_show"
                           class="form-control{{ $errors->has('country_tv_show') ? ' is-invalid' : '' }}"
            ...
            <input type="text" id="actors_tv_show"
                   class="form-control{{ $errors->has('Production_tv_show') ? ' is-invalid' : '' }}"
                   name="actors_tv_show" value="N/A" required autofocus><br>
            <div class="row">
                <div class="col-md-4">
                    <h4>Language :</h4>
                    <input type="text" id="language_tv_show"
                           class="form-control{{ $errors->has('language_tv_show') ? ' is-invalid' : '' }}"
                           name="language_tv_show" value="N/A" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4>Genre :</h4>
                    <input type="text" id="genre_tv_show"
                           class="form-control{{ $errors->has('genre_tv_show') ? ' is-invalid' : '' }}"
            ...
            <input type="text" id="plot_tv_show"
                   class="form-control{{ $errors->has('plot_tv_show') ? ' is-invalid' : '' }}"
