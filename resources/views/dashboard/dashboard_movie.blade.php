...
@section('content')
    ...
    <div id="Movies" class="tabcontent" style="display:block;">
        ...
        <form action="{{ url('insert_movie') }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="date" id="released_movie"
                           class="form-control"
                           name="released_movie" value="{{date('Y-m-d')}}" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4> Year:</h4>
                    <input type="number" max="2099" id="year_movie"
                           class="form-control" name="year_movie" value="{{date('Y')}}" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4>Country:</h4>
                    <input type="text" id="country_movie"
                           class="form-control{{ $errors->has('country_movie') ? ' is-invalid' : '' }}"
                           name="country_movie"
            ...
            <input type="text" id="actors_movie"
                   class="form-control{{ $errors->has('Production_movie') ? ' is-invalid' : '' }}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="language_movie"
                           class="form-control{{ $errors->has('language_movie') ? ' is-invalid' : '' }}"
                           name="language_movie" value="N/A" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4>Director :</h4>
                    <input type="text" id="director_movie"
                           class="form-control{{ $errors->has('director_movie') ? ' is-invalid' : '' }}"
            ...
            <input type="text" id="genre_movie"
                   class="form-control{{ $errors->has('genre_movie') ? ' is-invalid' : '' }}" name="genre_movie"
                   value="N/A" required autofocus><br>
            <h4>Plot :</h4>
            <input type="text" id="plot_movie"
                   class="form-control{{ $errors->has('plot_movie') ? ' is-invalid' : '' }}" name="plot_movie"
                   value="N/A" required autofocus><br>
            <div class="row">
                <div class="col-md-4">
                    <h4>Imdb Rating:</h4>
    ...
    <script type="text/javascript" src="{{asset('js//js/plupload.full.min.js')}}"></script>
