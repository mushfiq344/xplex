...
@section('content')
    ...
    <div id="Games" class="tabcontent" style="display:block;">
        ...
        <!--///////////////////////////////////////////-->
        <form action="{{ url('insert_game') }}" method="POST">
            @csrf
            <h4> Title:</h4>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="date" id="released_game"
                           class="form-control"
                           name="released_game" value="{{date('Y-m-d')}}" required autofocus>
                </div>
                <div class="col-md-4">
                    <h4>Production House :</h4>
                    <input type="text" id="publisher_game"
                           class="form-control{{ $errors->has('publisher_game') ? ' is-invalid' : '' }}"
            ...
            <input type="text" id="genre_game"
                   class="form-control{{ $errors->has('genre_game') ? ' is-invalid' : '' }}"
                   name="genre_game" value="N/A" required autofocus><br>
            <h4>Plot :</h4>
            <input type="text" id="plot_game"
                   class="form-control{{ $errors->has('plot_game') ? ' is-invalid' : '' }}" name="plot_game"
