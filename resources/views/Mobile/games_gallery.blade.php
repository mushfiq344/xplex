...
<div id="page-transitions" class="page-build light-skin highlight-blue">
    ...
    <div class="header header-scroll-effect">
        ...
        <div class="header-line-2 header-scroll-effect">
            ...
            <a href="#" class="header-title">Pc Games</a>
            ...
            <div class="content">
                <div class="accordion accordion-style-2">
                    ...
                    <div class="accordion-content" id="accordion-1a">
                        ...
                        <a href="{{url('mobile/Pc Games/'.$value->genre_type)}}" style="float: left; padding-left: 10px; color: white" class="button button-blue button-rounded bottom-10"> {{$value->genre_type}} </a>
                        <?php } ?>
                    </div>
                </div>
            </div>
            <div class="content">
                ...
                <div class="one-half">
                    <div>
                        ...
                        <h2 style="position: absolute; bottom: 2px; left: 15px; color: white; opacity: .8; z-index: 10; font-size: 17px;"> <i class="fa fa-star"></i> <span style="font-size: 15px; padding-left: 4px;"> {{$result[$i]->igdbrating}}</span></h2>
                        ...
                        <a href="{{url('/mobile/single_game/'.$result[$i]->id)}}"><img data-src="{{$result[$i]->poster_url_value}}" class="preload-image rounded-image responsive-image" alt="img"></a>
                    </div>
                </div>
                <div class="one-half last-column">
                    <div>
                        ...
                        <h2 style="position: absolute; bottom: 2px; left: 15px; color: white; opacity: .8; z-index: 10; font-size: 17px;"> <i class="fa fa-star"></i> <span style="font-size: 15px; padding-left: 4px;">{{$result[$i+1]->igdbrating}} </span></h2>
                        ...
                        <a href="{{url('/mobile/single_game/'.$result[$i+1]->id)}}"><img data-src="{{$result[$i+1]->poster_url_value}}" class="preload-image rounded-image responsive-image" alt="img"></a>
                    </div>
